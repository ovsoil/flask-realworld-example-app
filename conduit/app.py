...
from conduit import commands, user, profile, articles, api
...
def create_app(config_object=ProdConfig):
    ...
    """
    app = Flask(__name__.split('.')[0], static_folder=config_object.STATIC_DIR)
...
def register_blueprints(app):
    ...
    cors.init_app(api.blueprint, origins=origins)
